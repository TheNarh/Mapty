...
class App {
  ...
  _newWorkout(e) {
    ...
    if (type === 'running') {
      ...
      if (
        !valipInputs(distance, duration, cadence) ||
    ...
    if (type === 'cycling') {
      ...
      if (
        !valipInputs(distance, duration, elevation) ||
  ...
  _handleWorkoutActions(e) {
    ...
    if (btn.classList.contains('btn--delete')) {
      ...
      if (markerObj) this.#map.removeLayer(markerObj.marker);
